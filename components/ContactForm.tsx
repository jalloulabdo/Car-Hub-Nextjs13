...
const ContactForm = () => {
    return (
        <>
            <motion.div className='bg-slate-50 relative py-8 '
            variants={container}
            initial="hidden"
            whileInView="show"
            exit="exit"
            >
                <motion.div
                    className="max-w-screen-xl bg-slate-50   px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-xl"
                    variants={form}
                    >
                    <div className="flex flex-col justify-between">
                        ...
                        <div className="mt-8 text-center">
                            <svg className="w-full" xmlns="http://www.w3.org/1999/xlink"
